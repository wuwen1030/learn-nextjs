              ...
              >
                ...
                <div className="flex w-full items-center justify-between pt-4">
                  <div>
                    ...
                    <p className="dark:text-gray-400">{formatDateToLocal(invoice.date)}</p>
                  </div>
            ...
            <tbody className="bg-white dark:bg-black">
              {invoices?.map((invoice) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-3 dark:text-gray-400">
                    {invoice.email}
                  </td>
                  <td className="whitespace-nowrap px-3 py-3 dark:text-white">
                    {formatCurrency(invoice.amount)}
                  </td>
                  <td className="whitespace-nowrap px-3 py-3 dark:text-gray-400">
