...
export function CardSkeleton() {
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center truncate rounded-xl bg-white dark:bg-black px-4 py-8">
        <div className="h-7 w-20 rounded-md bg-gray-200 dark:bg-gray-800" />
      </div>
    </div>
  );
}
...
export function RevenueChartSkeleton() {
  return (
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
      <div className="mb-4 h-8 w-36 rounded-md bg-gray-100 dark:bg-gray-900" />
      <div className="rounded-xl bg-gray-100 dark:bg-gray-900 p-4">
        <div className="sm:grid-cols-13 mt-0 grid h-[410px] grid-cols-12 items-end gap-2 rounded-md bg-white dark:bg-black p-4 md:gap-4" />
...
export function InvoiceSkeleton() {
  return (
    <div className="flex flex-row items-center justify-between border-b border-gray-100 dark:border-gray-800 py-4">
...
export default function DashboardSkeleton() {
  return (
    <>
      <div
        className={`${shimmer} relative mb-4 h-8 w-36 overflow-hidden rounded-md bg-gray-100 dark:bg-gray-900`}
      />
...
export function InvoicesMobileSkeleton() {
  return (
    <div className="mb-2 w-full rounded-md bg-white dark:bg-black p-4">
      <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 pb-8">
        <div className="flex items-center">
          <div className="mr-2 h-8 w-8 rounded-full bg-gray-100 dark:bg-gray-900"></div>
          <div className="h-6 w-16 rounded bg-gray-100 dark:bg-gray-900"></div>
        </div>
        <div className="h-6 w-16 rounded bg-gray-100 dark:bg-gray-900"></div>
      </div>
      <div className="flex w-full items-center justify-between pt-4">
        <div>
          <div className="h-6 w-16 rounded bg-gray-100 dark:bg-gray-900"></div>
          <div className="mt-2 h-6 w-24 rounded bg-gray-100 dark:bg-gray-900"></div>
        </div>
        <div className="flex justify-end gap-2">
          <div className="h-10 w-10 rounded bg-gray-100 dark:bg-gray-900"></div>
          <div className="h-10 w-10 rounded bg-gray-100 dark:bg-gray-900"></div>
        </div>
      </div>
    </div>
